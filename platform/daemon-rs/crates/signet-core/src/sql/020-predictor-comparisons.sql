...
--   session_memories.entity_slot INTEGER
--   session_memories.aspect_slot INTEGER
--   session_memories.is_constraint INTEGER NOT NULL DEFAULT 0
--   session_memories.structural_density INTEGER
