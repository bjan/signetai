 ...
 * embed-extension.ts
 *
 * Reads the compiled Oh My Pi extension bundle from
 * ../extension/dist/signet-oh-my-pi.mjs and embeds it as a string
...
const extensionDistPath = join(packageRoot, "..", "extension", "dist", "signet-oh-my-pi.mjs");
 ...
 * Re-run the build to regenerate from ../extension/dist/signet-oh-my-pi.mjs
 */
